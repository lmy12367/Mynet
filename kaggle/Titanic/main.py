...
class TitanicDataset(Dataset):
    def __init__(self, train_path='/kaggle/input/titanic/train.csv',
...
def train_model(model, train_loader, criterion, optimizer, num_epochs=25, device='cuda'):
    ...
    for epoch in range(num_epochs):
        ...
        if epoch_loss < best_loss:
            ...
            print("Best model saved as /kaggle/working/models/best_model.pth")

        torch.save(model.state_dict(), '/kaggle/working/models/final_model.pth')
        print("Final model saved as /kaggle/working/models/final_model.pth")
